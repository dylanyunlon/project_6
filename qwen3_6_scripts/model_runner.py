...
class ModelInputForGPU(ModelRunnerInputBase):
    ...
    # objects are broadcast alongside the tensor dict.
...
class ModelInputForGPUBuilder(ModelRunnerInputBuilderBase[ModelInputForGPU]):
    ...
    def prepare(self,
        ...
        # BI100 GDN prefix-cache actions (reset each batch).
    ...
    def add_seq_group(self, seq_group_metadata: SequenceGroupMetadata):
        ...
        # BI100 GDN prefix-cache actions.
        gdn_actions = (
            getattr(seq_group_metadata, 'gdn_restore_key', None),
            getattr(seq_group_metadata, 'gdn_capture_points', None),
            getattr(seq_group_metadata, 'gdn_evict_keys', None),
            getattr(seq_group_metadata, 'gdn_segment_offsets', None),
        )
    ...
    def execute_model(
        ...
        **kwargs,
        ...
        if self.need_recv_kv(model_input, kv_caches):
            assert  not envs.VLLM_USE_INT8_MLA, "Disaggregated Prefilling does not support int8 MLA "
        ...
        # BI100 GDN prefix-cache kwargs for qwen3_5 model forward.
        gdn_prefix_kwargs = {}
