...
def get_masked_input_and_mask(
    ...
    # torch.complie with upper code causes wrong results, the following is working.
    # I guess our torch.compile processes "int * bool_tensor" still get a 0/1 results(should have a int results)
    valid_offset = (org_vocab_start_index *
                    org_vocab_mask.int()) + (added_offset * added_vocab_mask.int())
