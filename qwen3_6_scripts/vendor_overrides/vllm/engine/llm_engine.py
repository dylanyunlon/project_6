...
class LLMEngine:
    ...
    def __init__(
        ...
        num_virtual_engines = parallel_config.pipeline_parallel_size
        ...
        if dp_size > 1:
            ...
            dp_cache_config = CacheConfig(
                ...
                swap_space=cache_config.swap_space_bytes,
            ...
            if cache_config.num_gpu_blocks:
                dp_cache_config.num_gpu_blocks = (
                    cache_config.num_gpu_blocks // dp_size)
            if cache_config.num_cpu_blocks:
                dp_cache_config.num_cpu_blocks = (
                    cache_config.num_cpu_blocks // dp_size)

            self.scheduler = [
                Scheduler(
                    scheduler_config, dp_cache_config, lora_config,
                    num_virtual_engines,
