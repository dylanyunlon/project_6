...
from vllm.v1.utils import bind_kv_cache, bind_kv_cache_scale
    ...
    def initialize_kv_cache(self, kv_cache_config: KVCacheConfig) -> None:
        ...
        for kv_cache_group in kv_cache_config.kv_cache_groups:
            ...
            for layer_name in kv_cache_group.layer_names:
                ...
                assert tensor_config.size % (kv_cache_spec.page_size_bytes + kv_cache_spec.scale_page_size_bytes) == 0
                num_blocks = tensor_config.size // (kv_cache_spec.page_size_bytes + kv_cache_spec.scale_page_size_bytes)
                ...
                if isinstance(kv_cache_spec, AttentionSpec):
                    ...
                    if envs.VLLM_USE_INT8_MLA:
                        kv_caches_scale_shape = kv_cache_shape[:-1]+(2,)
                        kv_caches_scale[layer_name] = torch.zeros(kv_caches_scale_shape,
                                         dtype=torch.float32,
                                         device=self.device)
