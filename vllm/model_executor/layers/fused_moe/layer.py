...
class UnquantizedFusedMoEMethod(FusedMoEMethodBase, CustomOp):
    ...
    def apply(
        ...
        out = self.forward(
            ...
            apply_router_weight_on_input=apply_router_weight_on_input) * routed_scaling_factor
...
class FusedMoE(torch.nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor,
        ...
        if self.use_direct_call:
            return self.forward_impl(hidden_states, router_logits, extra_residual, routed_scaling_factor)
        else:
