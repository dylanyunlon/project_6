...
struct policy_selector {
  ...
  constexpr ThreeWayPartitionLookbackPolicy dispatch() const {
    ...
    if (offset_size==4 && input_size==4)
      return safe(512,11,BLOCK_LOAD_DIRECT,LOAD_DEFAULT,nd(840));
    if (offset_size==4 && input_size==8)
      return safe(256,10,BLOCK_LOAD_WARP_TRANSPOSE,LOAD_DEFAULT,nd(845));
    if (offset_size==8 && input_size==2)
      return safe(768,20,BLOCK_LOAD_WARP_TRANSPOSE,LOAD_DEFAULT,nd(500));
    if (offset_size==8 && input_size==4)
      return safe(768,15,BLOCK_LOAD_WARP_TRANSPOSE,LOAD_DEFAULT,nd(280));
    if (offset_size==8 && input_size==8)
      return safe(320,14,BLOCK_LOAD_WARP_TRANSPOSE,LOAD_DEFAULT,nd(620));

    // === SM90 tunings ===
    if (offset_size==4 && input_size==1)
      return safe(256,12,BLOCK_LOAD_DIRECT,LOAD_DEFAULT,nd(445));
    if (offset_size==4 && input_size==2)
      return safe(256,12,BLOCK_LOAD_DIRECT,LOAD_DEFAULT,nd(512));
    // SM90 offset=4 input=4 already covered by SM100 above
    // SM90 offset=4 input=8 already covered
    if (offset_size==4 && input_size==16)
      return safe(128,7,BLOCK_LOAD_WARP_TRANSPOSE,LOAD_DEFAULT,nd(1040));
    if (offset_size==8 && input_size==1)
      return safe(256,24,BLOCK_LOAD_DIRECT,LOAD_DEFAULT,nd(285));
    // offset=8 input=2,4,8 covered by SM100
    if (offset_size==8 && input_size==16)
      return safe(256,11,BLOCK_LOAD_WARP_TRANSPOSE,LOAD_DEFAULT,nd(1050));

    // === SM80 tunings ===
    if (offset_size==4 && input_size==2)
      return safe(256,12,BLOCK_LOAD_WARP_TRANSPOSE,LOAD_DEFAULT,nd(910));
    if (offset_size==4 && input_size==4)
      return safe(256,11,BLOCK_LOAD_WARP_TRANSPOSE,LOAD_DEFAULT,nd(1120));
    if (offset_size==4 && input_size==8)
      return safe(224,11,BLOCK_LOAD_WARP_TRANSPOSE,LOAD_DEFAULT,nd(1080));
    if (offset_size==4 && input_size==16)
      return safe(128,10,BLOCK_LOAD_WARP_TRANSPOSE,LOAD_DEFAULT,nd(1120));
